...
class Capturer():
    def __init__(self) -> None:
        ...
        self.publisher = rospy.Publisher('cmd_vel_latencies', Latencies, queue_size=1000)
        
        self.subscriber = rospy.Subscriber('/cmd_vel_stamped', TwistStamped, self.publish_to_latencies)
