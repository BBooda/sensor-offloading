...
#                        Forth argument: Port
tmux send-keys -t 1 "sleep 2; export ROS_IP=127.0.0.1; cd $TEMP_DIR; python3 udp_sub_client.py /pixy/vicon/demo_crazyflie6/demo_crazyflie6/odom odometry $TARGET_IP 31404" C-m
...
tmux send-keys -t 3 "sleep 2; export ROS_IP=127.0.0.1; cd $TEMP_DIR; python3 udp_sub_client_twist.py /demo_crazyflie12/cmd_vel late $TARGET_IP 31182" C-m
